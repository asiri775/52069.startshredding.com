                            ...
                            <div class="row row-same-height">
                                <div class="col-md-6 b-r b-dashed b-grey sm-b-b">
                                    <div class="sm-padding-5 sm-m-t-15 m-t-15">
                                        <div class="form-group form-group-default required" style="background-color: #68a0fb42;">
                                            <label class="control-label">Address</label>
                                            <input autocomplete="off" id="autocomplete" placeholder="Enter address here" type="text" value="{{ $address }}" class="form-control" aria-required="true" style="border-radius: 0; width: 100%; margin-top: 5px; margin-bottom: 5px;background-color: white;">
                                            
                                            <ul id="result" class="serachwrap" style="display: block; position: relative; top: 0;">
                                                <li title="{{ $address }}" id="onload_click">
                                ...
                                <div class="col-md-9">
                                    <div class="padding-30 sm-padding-5">
                                        ...
                                        <section class="cnt">
                                            ...
                                            <input type="hidden" value="" name="service_preference" id="service_preference">
                                            <div id="type1" class="targetType">
                                                ...
                                                <script>
                                                    $(document).ready(function () {
                                                        ...
                                                        $('#service_one').on('click', function () {
                                                            service(this.id);
                                                            // $('#service_type').val($('#' + this.id).data('service-type'));
                                                        });

                                                        $('#service_two').on('click', function () {
                                                            service(this.id);
                                                            // $('#service_type').val($('#' + this.id).data('service-type'));
                                                        });

                                                        $('#service_three').on('click', function () {
                                                            service(this.id);
                                                            // $('#service_type').val($('#' + this.id).data('service-type'));
                                                        });

                                                        $('#shredding_one').on('click', function () {
                                                            shredding(this.id);
                                                            // $('#service_preference').val($('#' + this.id).data('shredding-type'));
                                                        });

                                                        $('#shredding_two').on('click', function () {
                                                            shredding(this.id);
                                                            // $('#service_preference').val($('#' + this.id).data('shredding-type'));
                                                        });

                                                        $('#shredding_three').on('click', function () {
                                                            shredding(this.id);
                                                            // $('#service_preference').val($('#' + this.id).data('shredding-type'));
                                                        });
