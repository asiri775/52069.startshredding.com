...
<script
    src='https://maps.googleapis.com/maps/api/js?key=AIzaSyCRu_qlT0HNjPcs45NXXiOSMd3btAUduSc&libraries=places&callback=initAutocomplete'></script>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#autocomplete").on("keyup", function (e) {
            ...
            // Request US predictions
            service.getPlacePredictions(request1, function (predictions, status) {
                callback(predictions, status);
            });

            // Request CA predictions
            service.getPlacePredictions(request2, function (predictions, status) {
                callback(predictions, status);
            });
        });
        ...
        function callback(predictions, status) {
            ...
            //         resultData += '<li title="' + predictions[i].description + '"><a href="{{ url("/request_quote_us") }}?address=' + predictions[i]
                    ...
                    <div class="slider-wrapper">
                        <div class="background-wrapper" data-swiper-parallax="30%">
                            ...
                            <div class="background"
                                data-pages-bg-image="{{ URL::asset('assets_new/assets/images/new-slider-1.jpg') }}">
                            </div>
                        </div>
                    </div>
                    <!-- END IMAGE PARRALAX -->
                                    ...
                                    <div class="container">
                                        <div class="col-md-12 no-padding col-xs-12">
                                            <h1 class="text-white sm-text-center" data-swiper-parallax="-15%"
                                                data-aos="fade-down" data-aos-easing="linear" data-aos-duration="1700">
                                                Los Angeles Shredding Service</h1>
                                            ...
                                            <div class="search-box ae-4 done" data-aos="fade-down"
                                                ...
                                                <form method="get" action="request_quote_us/">
                                                    <div class="location-field">
                                                        <input type="text" name="address" id="autocomplete"
                                                            placeholder="Enter your EXACT adress" class="xs-full-width">
                                            ...
                                            <p class="text-white m-t-20" data-aos="fade-down" data-aos-easing="linear"
                                                data-aos-duration="1800">Take a peek at some
                ...
                <div class="swiper-slide fit">
                    ...
                    <div class="slider-wrapper">
                        <div class="background-wrapper" data-swiper-parallax="30%">
                            <!-- YOUR BACKGROUND IMAGE HERE, YOU CAN ALSO USE IMG with the same classes -->
                            <div class="background"
                                data-pages-bg-image="{{ URL::asset('assets_new/assets/images/new-slider-2.jpg') }}">
                            </div>
                        </div>
                    </div>
                    <!-- END IMAGE PARRALAX -->
                                ...
                                <div class="col-xs-height col-middle text-center">
                                    <div class="container">
                                        <div class="col-md-12 no-padding col-xs-12">
                                            ...
                                            <h1 class="text-white sm-text-center" data-swiper-parallax="-15%"
                                                data-aos="fade-down" data-aos-easing="linear" data-aos-duration="1100">
                                                Los Angeles Shredding Service</h1>
                                            <p class="sm-text-center" data-aos="fade-down" data-aos-easing="linear"
                                            ...
                                            <p class="text-white m-t-20" data-aos="fade-down" data-aos-easing="linear"
                                                data-aos-duration="1700">Take a peek at some
                                                of our <b>satisfied</b>
                                                customers</p>
                                        </div>
                                    </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-5 b-r b-grey xs-b-b b-grey">
                ...
                <h3 class="no-margin"><span data-pages-animate="number" data-value="15" data-animation-duration="800"
                        data-aos="fade-down" data-aos-easing="linear" data-aos-duration="1500">0</span> YEARS</h3>
                <h3 class=" no-margin"><span data-pages-animate="number" data-value="1000" data-animation-duration="800"
                        data-aos="fade-down" data-aos-easing="linear" data-aos-duration="1500">0</span> + CUSTOMERS
                </h3>
                ...
                <div class="col-md-4 col-sm-4">
                    <div class="m-t-15" data-aos="fade-right" data-aos-duration="1500">
                        <img alt="" class="image-responsive-height image-responsive-width"
                            src="{{ URL::asset('assets_new/assets/images/off-site-shreding.jpg') }}" id="mobile_phone">
                    </div>
                </div>
...
<section class="p-b-85 p-t-75 bg-master-lighter">
    <div class="container">
        ...
        <div class="md-p-l-20 md-p-r-20 xs-no-padding">
            <div class="row">
                <div class="col-xs-12 col-sm-6 col-md-4 col-sm-offset-3" data-aos="fade-up" data-aos-duration="2000">
