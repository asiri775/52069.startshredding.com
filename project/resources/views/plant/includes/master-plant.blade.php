...
<head>
    ...
    <title>{{$settings[0]->title}} - Plant User Panel</title>
    ...
    <link href="{{ URL::asset('assets/vendor/css/custom.css')}}?v=<?=$assetVersion?>" rel="stylesheet">
            ...
            <header class="type-1">
                <div class="header-product">
                    <div class="logo-wrapper">
                        <div class="row">
                            <div class="col-md-6">
                                <a href="{!! url('plant/dashboard') !!}" id="logo">
                ...
                <div class="navigation">
                    ...
                    <div class="nav-overflow">
                        <nav>
                            <ul>
                                <li class="simple-list"><a href="{!! url('plant/dashboard') !!}" class="">Dashboard</a></li>
